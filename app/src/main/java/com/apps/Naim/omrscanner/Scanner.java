...
import static com.apps.Naim.omrscanner.Util.sortLeft2Right;
import static com.apps.Naim.omrscanner.Util.sortTopLeft2BottomRight;
import static com.apps.Naim.omrscanner.Util.sout;
import static com.apps.Naim.omrscanner.Util.write2File;
...
//            double childId = ids[2];
    ...
    private void findBubbles() throws Exception {
        ...
        if(false){ // drafts.size() != questionCount * options.length
